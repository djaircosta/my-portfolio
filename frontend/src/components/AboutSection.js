        ...
        >
            <Description>
                ...
                <motion.p variants={fade}>
                    I'm a software engineer who is passionate about making code more accessible, creating technology to elevate people, and building community. Some technologies I enjoy working with include chatbots, the MERN (Mongo, Express, React and Node) stack and JAVA. I am currently working on an awesome startup called Daytech.
                </motion.p>
            ...
            <Image>
                <motion.div variants={photoAnimation}>
                    <img alt='Djair Santos' src={profile} />
                </motion.div>
            </Image>
            <Wave />
        </About>
